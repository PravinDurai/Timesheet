...
public interface SandhataDao {
	...
	public void createNewUser(UsersDto userDto);
        ...
        public void getMyTimeSheet(List<TimeSheetDto> timeSheetDto, String companyName, String department, String project, String consultantName, Date startDate, Date endDate);       
