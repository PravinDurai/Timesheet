...
public class TimeSheetEntity {
    ...
    public TimeSheetEntity(String name, String encUserName, String companyName, String department, String date, float proportion, String projectName, String projectCode, String comments) {
        super();
        this.name = name;
    ...
    public TimeSheetEntity(Integer id, String name, String encUserName, String companyName, String department, String date, float proportion, String projectName, String projectCode, String comments) {
        super();
        this.id = id;
        this.name = name;
        this.encUserName = encUserName;
