...
public class ProjectAssignDto { 
	...
	public ProjectAssignDto(int id, String department, float proportion, UsersDto usersDto, String projectName,
		...
		this.usersDto = new UsersDto(projectAssignEntity.getUsersEntity());
		this.projectName = projectAssignEntity.getProjectName();
		this.projectCode = projectAssignEntity.getProjectCode();
	}
	...
	public String toString() {
		return "ProjectAssignDto [id=" + id + ", department=" + department + ", proportion=" + proportion
				+ ", usersEntity=" + usersDto + ", projectName=" + projectName + ", projectCode=" + projectCode
				+ "]";
	}	
}
